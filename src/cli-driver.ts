...
import { generateKubeconfigHandler } from './handlers/generate/generate-kubeconfig.handler';
...
export class CliDriver
{
    ...
    private getCliDriver(isSystemTest: boolean, baseCmd: string) {
        return yargs()
            ...
            .middleware(async () => {
                if(this.adminOnlyCommands.has(baseCmd) && !this.configService.me().isAdmin){
